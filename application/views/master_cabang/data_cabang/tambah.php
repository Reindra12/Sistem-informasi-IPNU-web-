<form action="<?= base_url('cabang/simpan') ?>" name="tambah_cabang" method="POST" enctype="multipart/form-data" onsubmit="return form_cabang()">
    <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" name="cabang" class="form-control" placeholder="Masukan Nama Anak cabang...">
        </div>
        ...
        <div class="form-group">
            ...
            <select name="level" class="form-control">
                ...
                <option value="1" <?= set_value('level') == 1 ? "selected" : null ?>>Admin Cabang</option>
                <option value="2" <?= set_value('level') == 1 ? "selected" : null ?>>Anak Cabang</option>
            </select>
        </div>
        <div class="card-body">
